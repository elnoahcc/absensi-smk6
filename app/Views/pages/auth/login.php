...
<head>
  ...
  <title>Absensi Enuma Technology</title>
...
<body class="hold-transition login-page" style="background-image: url('<?=base_url()?>images/login-background2.jpg'); background-size: cover;">
<div class="login-box">
  <!-- /.login-logo -->
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <h3>Sistem Absensi</h3>
      <img src="<?=base_url()?>enumatech2.png" alt="" style="width: 200px">
    </div>
    <div class="card-body">
